function MainController($log, $interval, LogService) {
  ...
  var tempVisualizationData = [];
  $interval(function () {
    vm.isLoading = false;
    tempVisualizationData = [
      [
         ['Element', 'Density', { role: 'style' }, { role: 'annotation' }],
    ...
    tempVisualizationData.map(function(visualizationData, index) {
      vm.visualizationData[index].data = visualizationData;
    })
  }, 5000);
}
